#!/usr/bin/env python3
"""XAUUSD Gold-Dollar research strategy v4.7.
...
v4.7 blocks Friday last session hour (19-20 UTC) when real spread/ATR is elevated vs the 20-day same-hour median. No fake spread.
"""
