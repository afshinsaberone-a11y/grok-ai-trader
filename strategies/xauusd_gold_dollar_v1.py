#!/usr/bin/env python3
"""XAUUSD Gold-Dollar research strategy v2.6.

Does not download market data. Feed a real OHLCV dataset.
Optional real spread/news_high columns only. No fake OHLCV.
v2.6 blocks entries when Monday-morning / Asia-reopen spread is wide vs ATR.
"""
...
class XAUUSDGoldDollarV1:
    ...
    def signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        base = squeeze & vol_ok & d["session_ok"] & d["cost_ok"] & shock_ok & quality_ok & news_ok & gap_ok & open_spread_ok
