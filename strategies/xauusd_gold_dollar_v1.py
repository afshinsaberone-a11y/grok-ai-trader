#!/usr/bin/env python3
"""XAUUSD Gold-Dollar research strategy v3.3.
...
v3.3 also blocks last session hour (19-20 UTC) when real hourly volume is thin vs its 20-day median. No fake volume.
"""
    ...
    def prepare(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        if isinstance(out.index, pd.DatetimeIndex):
            ...
            out["session_ok"] = (
                ...
                & (~out["session_close_thin_vol_block"])
            )
