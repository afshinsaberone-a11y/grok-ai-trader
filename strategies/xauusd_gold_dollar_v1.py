#!/usr/bin/env python3
"""XAUUSD Gold-Dollar research strategy v3.5.
...
v3.5 blocks Monday first London hour (07-08 UTC) only when real spread is wide vs ATR after the weekend. No fake spread.
"""
