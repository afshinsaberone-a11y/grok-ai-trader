#!/usr/bin/env python3
"""XAUUSD Gold-Dollar research strategy v5.4.
...
v5.4 blocks Wednesday last session hour (19-20 UTC) when real spread/ATR is elevated
vs the 20-day same-hour median, and (AND) when volume is thin vs same-hour median. No fake spread/volume.
"""
