#!/usr/bin/env python3
"""XAUUSD Gold-Dollar research strategy v3.9.
...
v3.9 blocks Tuesday first London hour (07-08 UTC) when real spread/ATR is elevated vs the 20-day median of the same Tuesday hour. No fake spread.
"""
