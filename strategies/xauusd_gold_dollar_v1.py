#!/usr/bin/env python3
"""XAUUSD Gold-Dollar research strategy v4.8.
...
v4.8 blocks Friday last session hour (19-20 UTC) when real spread/ATR is elevated vs the 20-day same-hour median AND volume is thin vs the same-hour median. No fake spread/volume.
"""
