...
Uses strict gate v4. 2022-2024 are discovery years; 2025 is validation;
...
from research.optimization.cost_aware_gate_v4 import PRE_OOS_YEARS, MIN_PROFITABLE_YEARS, MIN_PF_EACH_YEAR, MIN_EXPECTANCY_R, MIN_TRADES_EACH_YEAR, PRE_OOS_MAX_DD_PCT, VALIDATION_MIN_PF, VALIDATION_MAX_DD_PCT, candidate_gate, pre_oos_gate
PIP_SIZE=0.0001
