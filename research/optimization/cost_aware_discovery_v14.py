...
Uses strict gate v14. 2022-2024 are discovery years; 2025 is validation; 2026 is held out.
"""
...
from research.optimization.cost_aware_gate_v14 import PRE_OOS_YEARS,MIN_PROFITABLE_YEARS,MIN_PF_EACH_YEAR,MIN_EXPECTANCY_R,MIN_TRADES_EACH_YEAR,PRE_OOS_MAX_DD_PCT,VALIDATION_MIN_PF,VALIDATION_MAX_DD_PCT,VALIDATION_MIN_TRADES, candidate_gate,pre_oos_gate
