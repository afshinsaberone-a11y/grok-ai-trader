...
### v6.9 — 2026-09-26
- ارتقا: فیلتر دوشنبه ری‌اوپن آسیا نسبت اسپرد/ATR بالا AND حجم نازک همان ساعت.
- پایتون: `monday_asia_reopen_thin_vol_ratio=0.70`، `monday_asia_reopen_vol_lookback=20`. تابع `monday_asia_reopen_spread_atr_med_thin_block` فقط وقتی True است که دوشنبه 00–02 UTC و نسبت اسپرد/ATR نسبت به میانه ۲۰روزه همان ساعت بالا باشد و حجم واقعی همان ساعت < 0.70 میانه ۲۰روزه همان ساعت باشد. اگر ستون حجم نباشد فیلتر AND خاموش می‌ماند. اسپرد/حجم جعلی ساخته نمی‌شود.
- EA: `MondayAsiaReopenThinVolRatio=0.70`، `MondayAsiaReopenVolLookback=20` و `MondayAsiaReopenSpreadAtrMedThinBlock()` روی iVolume ساعتی واقعی دوشنبه‌های 00–02. نسخه 6.90.
- ریسک پایه ۰.۵٪. سود تضمین نیست. معامله زنده فعال نشد.
- مورد بعدی: فیلتر سه‌شنبه ری‌اوپن آسیا نسبت اسپرد/ATR بالا AND حجم نازک همان ساعت.
